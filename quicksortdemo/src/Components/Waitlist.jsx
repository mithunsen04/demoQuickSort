...
export default function Waitlist() {
  ...
  //     await axios.post('/', { name, email, message });
  ...
  //     alert('Error creating waitlist entry');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://alive-jade-hatchling.cyclic.app/', {
       name,
        email,
        message,
      });
      ...
      toast({
        title: 'You have succesfully joined the Waitlist  ',
